...
- **Enable workspace access** — When you open a new workspace folder, the extension will ask to enable workspace access. Enable it **only** for your study/homework project.

- **Set GitHub Copilot Chat to Debug mode** — If you see “GitHub Copilot Chat must be in Debug mode”, click **Open Menu** → **GitHub Copilot Chat** → **Debug**.

   (These steps are shown in the demo 0:42 → 0:54 in [copilot_archiver_instructions.mov](https://drive.google.com/file/d/18tCphUyFp4M1Gzj-G31jVM62Y9F_9vY2/view?usp=sharing).)
   ![Select GitHub Copilot Chat](test/image1.png)
   ![Select Debug](test/image2.png)
...
### Test run the extensions and Copilot:
 ...
 - Select the `AIxD_study_instruction/test` folder to [open as your workspace](https://code.visualstudio.com/docs/getstarted/getting-started#_open-a-folder-in-vs-code) in VS Code
 ...
 - Enter a random prompt to make sure the coding agent works. E.g., "make a hello world app".
 - Take a snapshot of your workspace in VS Code by clicking "Archiver: {yourid}" button (bottom right corner) and "Capture Repo Snapshot" 
...
## 3. Configure the chatbot for iterative chatbot tasks
